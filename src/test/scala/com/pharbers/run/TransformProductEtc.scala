...
object TransformProductEtc extends App {
    ...
    val pfizerCpaDF = CSV2DF(pfizer_cpa_csv).select("PRODUCT_NAME", "MOLE_NAME", "PACK_DES", "PACK_NUMBER", "DOSAGE", "DELIVERY_WAY", "CORP_NAME")
    val pfizerGycDF = CSV2DF(pfizer_gyc_csv).select("PRODUCT_NAME", "MOLE_NAME", "PACK_DES", "PACK_NUMBER", "DOSAGE", "DELIVERY_WAY", "CORP_NAME")
