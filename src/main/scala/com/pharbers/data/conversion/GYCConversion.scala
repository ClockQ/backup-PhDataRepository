        ...
        val connProdHosp = {
            gycDF
                    ...
                    .join(
                        ...
                        , gycDF("PRODUCT_NAME") === phProdDF("PH_PRODUCT_NAME")
                                && gycDF("MOLE_NAME") === phProdDF("PH_MOLE_NAME")
                                && gycDF("DOSAGE") === phProdDF("PH_DOSAGE_NAME")
                                && gycDF("PACK_DES") === phProdDF("PH_PACKAGE_DES")
                                && gycDF("PACK_NUMBER") === phProdDF("PH_PACKAGE_NUMBER")
                                && gycDF("CORP_NAME") === phProdDF("PH_CORP_NAME")
                        , "left"
                    )
//                .drop(prodDF("dosage"))// 同名重复，要删掉
        ...
        val gycERD = connProdHosp
                ...
                .str2Time
                .select("_id", "COMPANY_ID", "TIME", "HOSPITAL_ID", "PH_PRODUCT_ID", "VALUE", "STANDARD_UNIT")
